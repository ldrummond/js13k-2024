import { canvas_height, canvas_width, globals, main_canvas, main_ctx, resource_list, spritesheet_img } from './core/constants';
import { createGameStateMachine } from './game-state-machine';
import DebugPanel from './debug';
import { GameLogic } from './core/game-logic';
import { game_entities_data, GameEntity } from './core/game-entity';
import { UIText } from './core/ui-text';
import Sprite, { canvasFromSpritesheet } from './core/sprite';
import spritesheet_json from './assets/spritesheet.json';
...
function start() {
  ...
  const game_entities: GameEntity[] = game_entities_data.map(d => new GameEntity(d));
